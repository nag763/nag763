            ...
            <div className="hero h-full">
                <div className="hero-content ">
                    <div className="max-w-md md:max-w space-y-8">
                        <h1 className="text-5xl md:text-8xl text-left md:text-center font-bold">LABEYE Loïc</h1>
                        <div className="pl-6 text-xl md:text-3xl font-semibold space-y-2">
                        ...
                        <p className="animate-fade-up text-lg md:text-xl animate-duration-1000 animate-delay-[4000ms]">
                            {t('intro')}
                        </p>
