...
pub fn scholarship() -> impl IntoView {
    ...
    <div class="grid grid-rows-6 2xl:flex 2xl:flex-col flex flex-col h-full justify-center 2xl:justify-between py-4 overflow-y-auto items-center  2xl:items-stretch animate-fade animate-duration-100 animate-ease-in">
        ...
        <li>
          ...
          <div class="timeline-start mb-10 text-start md:text-end animate-fade-right  animate-once animate-delay-[500ms] animate-ease-in">
        ...
        <hr />
            ...
            <div class="timeline-start mb-10 text-start md:text-end animate-fade-right animate-once animate-delay-[1500ms] animate-ease-in">
