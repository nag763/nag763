...
pub(crate) mod common {
    ...
    pub(crate) fn project_card(
        ...
        view! {
            <div >
                <a href=card_href target={match card_href { "#" => "" , _ => "_blank"}} class="flex flex-col items-center bg-white border border-gray-500 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600 h-full">
